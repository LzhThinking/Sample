...
public class CommonGridDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommonGridDecoration(int horizonSpan,int verticalSpan,int color,boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        Log.d("zhiheng", "position = " + itemPosition + "column = " + column + ", left = " + left + ", right = " + right);
