...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyItemDecoration(int marginLeft) {
        this(Color.parseColor("#eaeaea"), 1, marginLeft, 0);
    }

    public StickyItemDecoration(int marginLeft, int marginRight) {
        this(Color.parseColor("#eaeaea"), 1, marginLeft, marginRight);
    }

    public StickyItemDecoration(int dividerColor, int dividerHeight, int marginLeft, int marginRight) {
        this(dividerColor, dividerHeight, marginLeft, marginRight, 1);
    }

    public StickyItemDecoration(int dividerColor, int dividerHeight, int marginLeft, int marginRight, int startPosition) {
